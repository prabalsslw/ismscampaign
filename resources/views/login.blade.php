...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>SSL CARE | USER LOGIN</title>
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="index.html">
                <img src="assets/pages/img/ssl2.png" alt="" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            ...
            <form class="login-form" action="login" method="post">
                ...
                @if(Session::has('flash_message'))
                    <div style="font-size: 15px;color: red;" class="alert alert-danger">
        ...
        <!-- END LOGIN -->
        <!-- BEGIN COPYRIGHT -->
        <div class="copyright"> 2017 &copy; SSL Wireless - Admin Dashboard. </div>
        <!-- END COPYRIGHT -->
        <!--[if lt IE 9]>
